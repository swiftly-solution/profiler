...
internal class ProfileService
{
    ...
    {
        StartRecordingWithIdentifier("CounterStrikeSharp", name);
    }

    public void StopRecording(string name)
    {
        StopRecordingWithIdentifier("CounterStrikeSharp", name);
    }

    public void RecordTime(string name, double duration)
    {
        RecordTimeWithIdentifier("CounterStrikeSharp", name, duration);
    }
